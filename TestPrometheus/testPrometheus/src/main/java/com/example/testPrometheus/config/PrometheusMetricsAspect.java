...
public class PrometheusMetricsAspect {
    ...
    public static final Counter helloTotal = Counter.build().name("hello_all").labelNames("api").help
            ("total request couter of api").register();
    ...
    // 自定义Prometheus注解的全路径
    @Pointcut("@annotation(com.example.testPrometheus.config.PrometheusMetrics)")
